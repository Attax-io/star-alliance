...
| [`dashboard-parity`](star-alliance-skills/dashboard-parity/SKILL.md) | 1.0.1 | own | 159 / 1008 | 1164 / 52 | ✓ lean | The Quartermaster's craft for proving a change actually reaches the rendered dashboard at … |
...
| [`japanese-candlesticks`](star-alliance-skills/japanese-candlesticks/SKILL.md) | 1.0.0 | own | 128 / 1012 | 965 / 61 | ✓ lean | The Merchant's read-only craft for reading Japanese candlestick charts, distilled from Ste… |
...
| [`skillsmith`](star-alliance-skills/skillsmith/SKILL.md) | 1.3.1 | own | 132 / 987 | 4288 / 149 | ✓ lean | Manage, sync, upgrade, create, and auto-evolve Star Alliance skills across the star-allian… |
...
| [`trading-strategy`](star-alliance-skills/trading-strategy/SKILL.md) | 0.1.0 | own | 139 / 1009 | 901 / 56 | ✓ lean | The Merchant's craft for read-only trading-strategy design that ships a written, dated str… |
...
| [`weapon-utility`](star-alliance-skills/weapon-utility/SKILL.md) | 1.1.1 | own | 152 / 922 | 1116 / 123 | ✓ lean | Every member's rule for which weapon (model) to draw and how thinker and doer weapons work… |
...
_46 skills — 39 lean · 6 large (installable, over the 500-line ideal) · 1 near the word ceiling · 0 hard violations._
