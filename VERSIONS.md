...
| [`arsenal-forge`](star-alliance-skills/arsenal-forge/SKILL.md) | 1.0.1 | own | 147 / 949 | 1366 / 93 | ✓ lean | The Strategist's craft for recruiting a new weapon (AI model) into the guild arsenal, or r… |
...
| [`backend-auditor`](star-alliance-skills/backend-auditor/SKILL.md) | 1.0.0 | own | 66 / 480 | 297 / 25 | ✓ lean | Audits the Lex Council Supabase schema (tables, views, triggers, RPC functions, cron jobs,… |
...
| [`butler-voice`](star-alliance-skills/butler-voice/SKILL.md) | 2.0.0 | own | 110 / 786 | 2239 / 286 | ✓ lean | How the Butler speaks to the Guild Master — the delivery standard, taught as concrete exam… |
...
| [`check-point-resched`](star-alliance-skills/check-point-resched/SKILL.md) | 1.0.0 | own | 54 / 380 | 1071 / 82 | ✓ lean | Reference documentation for Star Alliance's automatic per-turn checkpoint commit (turn-fin… |
...
| [`new-member-onboarding`](star-alliance-skills/new-member-onboarding/SKILL.md) | 1.0.1 | own | 52 / 366 | 819 / 170 | ✓ lean | The exact checklist to run whenever a new guild member is recruited |
...
| [`skillsmith`](star-alliance-skills/skillsmith/SKILL.md) | 1.8.0 | own | 132 / 987 | 5755 / 170 | ○ large | Manage, sync, upgrade, create, and auto-evolve Star Alliance skills across the star-allian… |
...
| [`star-alliance-language`](star-alliance-skills/star-alliance-language/SKILL.md) | 1.2.1 | own | 84 / 522 | 952 / 114 | ✓ lean | The guild's shared reading protocol for OKF-tidied repos — how every member quickly, cheap… |
