...
| `code-review-craft` | a deliberate review of a diff/PR/file across correctness/security/simplify/efficiency | a quick self-check of your own routine work (do it inline) or fixing a known bug (→ `bug-fix-workflow`) | `bug-fix-workflow`, `automated-testing` |
