...
the-designer "…"`, the doer path; MiniMax is the substitute only when Hermes is
unreachable) to produce the visual or UX draft, then I read it back against the
request: **accessibility** (a11y-craft) and **unity** (design-unity). If it
holds, I report it. If it falls short, I re-dispatch with the reason before I
