...
description: How to pull and summon the deepseek-v4-pro weapon (generated from models.json).
...
```
python3 star-alliance-arsenal/summon.py deepseek-v4-pro "<prompt>" --max-tokens 16000
```
