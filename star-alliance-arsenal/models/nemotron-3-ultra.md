...
description: How to pull and summon the nemotron-3-ultra weapon.
...
NVIDIA reasoning bench — alternate engine.
...
```
python3 star-alliance-arsenal/summon.py nemotron-3-ultra "<prompt>" --max-tokens 4000
```
