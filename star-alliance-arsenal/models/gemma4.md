...
type: Reference
title: gemma4
description: How to pull and summon the gemma4 weapon (generated from models.json).
...
Light, fast thinker — cheap second mind, esp. content/marketing (the-herald).
...
```
python3 star-alliance-arsenal/summon.py gemma4 "<prompt>" --max-tokens 16000
```
