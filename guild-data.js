...
const GUILD = {
  "meta": {
    ...
    "generated": "2026-06-29T15:14:10Z",
    "schemaVersion": 3,
    "weaponStatus": {
      "opus": "reserve",
      "sonnet": "reserve",
  ...
  "members": [
    {
      ...
      "weapons": [
        ...
        {
          "model": "glm-5.2",
          "desc": "Brain — A different analytical frame — where others over-fit."
        }
      ],
      "does": [
        "Domain modeling and transaction boundaries",
    ...
    },
    {
      "id": "the-connector",
      "name": "The Connector",
      "role": "Capability Bridge · Gap-Filler",
      "model": "sonnet",
      "conferred": "Foundational",
      "color": "#3da1a8",
      "avatar": "<svg viewBox=\"0 0 96 96\"><defs><radialGradient id=\"a-conn\" cx=\"50%\" cy=\"35%\" r=\"60%\"><stop offset=\"0\" stop-color=\"#102a2c\"/><stop offset=\"1\" stop-color=\"#081a1c\"/></radialGradient></defs><rect width=\"96\" height=\"96\" rx=\"12\" fill=\"url(#a-conn)\"/><circle cx=\"22\" cy=\"48\" r=\"6\" fill=\"none\" stroke=\"#4ec9c4\" stroke-width=\"2\"/><circle cx=\"74\" cy=\"48\" r=\"6\" fill=\"none\" stroke=\"#4ec9c4\" stroke-width=\"2\"/><path d=\"M28 48 L68 48\" stroke=\"#4ec9c4\" stroke-width=\"2.5\" stroke-linecap=\"round\"/><path d=\"M28 48 Q40 36 48 48 Q56 60 68 48\" fill=\"none\" stroke=\"#4ec9c4\" stroke-width=\"1.5\" opacity=\".5\"/><path d=\"M28 48 Q40 60 48 48 Q56 36 68 48\" fill=\"none\" stroke=\"#4ec9c4\" stroke-width=\"1.5\" opacity=\".5\"/><circle cx=\"48\" cy=\"48\" r=\"3\" fill=\"#4ec9c4\"/><path d=\"M48 20 L48 30 M48 66 L48 76\" stroke=\"#4ec9c4\" stroke-width=\"1.5\" opacity=\".4\"/></svg>",
      "summary": "Capability bridge and gap-filler. Holds the Claude connectors (Supabase, WhatsApp, Gmail, Calendar, web search/fetch, computer-use) the other members cannot reach, and serves as the sanctioned overflow doer after a stuck specialist logs seven genuine attempts.",
      "deploy": "Connector work (Supabase, WhatsApp, Gmail, Calendar, web search/fetch, computer-use), overflow doer after seven logged tries",
      "triggers": "connect to <service> · I need Supabase access · I need WhatsApp · send via Gmail · read the calendar · fetch the web · open the browser · every ordinary route is stuck",
      ...
      "does": [
        "Reaching the Claude connectors (Supabase, WhatsApp, Gmail, Calendar, web search/fetch, computer-use) the rest of the guild cannot",
        "Pulling blocked, paywalled, or JS-heavy content via the Claude connector path",
        "Triage of comms inboxes (Gmail/WhatsApp/Calendar) before a specialist acts",
        "Pulling financial data the Merchant cannot reach natively",
        "Sanctioned overflow doer — taking over a stuck ticket after the seventh logged attempt"
      ],
      "doesnt": [
        "Does not design systems — delegate to The Architect",
        "Does not write application code — delegate to The Developer",
        "Does not design UIs — delegate to The Designer",
        "Does not plan campaigns — delegate to The Strategist",
        "Does not translate laws — delegate to The Translator",
        "Does not run marketing — delegate to The Herald",
        "Does not analyse investments — delegate to The Merchant",
        "Does not manage the skill registry — delegate to The Quartermaster",
        "Is never the first routing target for ordinary craft — gap-filler only"
      ],
      "skills": [
        "agent-web-reach",
        "api-integration-design",
  ...
  "skills": [
    ...
    },
    {
      ...
      "tabler": "ti-puzzle",
      "src": "own",
      "desc": "The dual-review flow that backs the cross-system bridge. A specialist CLI profile receives an order from a Claude Code subagent, dispatches MiniMax-M3 (the doer) to do the actual work, and simultaneously fires Kimi K2.7 (Ollama Cloud) and GLM-5.2 (Ollama Cloud) as parallel reviewer sub-agents through Hermes. Both reviewers must independently pass before the work is reported back. Triggers: 'dual review', 'two reviewers', 'kimi and glm review', 'review in parallel', 'M3 does, reviewers check', 'three-way review', or any time a profile is about to declare a piece of work done for the cross-system bridge. Pairs with weapon-utility (seat doctrine — M3 is the doer, Kimi + GLM are independent thinkers), decompose-and-swarm (when many slices each need dual review), and the cross-system dispatch bridge (tools/dispatch.py).",
      "intro": "The dual-review flow is the cross-system bridge's quality gate. A specialist CLI profile (Architect, Developer, Designer, Herald, Merchant, Quartermaster, Translator) receives an order from a Claude Code subagent. It dispatches MiniMax-M3 as the doer to do the work, then in parallel fires two Ollama",
      "sections": [
        "What it is / is not",
        "The seat triangle",
      ...
      "triggers": "'dual review', 'two reviewers', 'kimi and glm review', 'review in parallel', 'M3 does, reviewers check', 'three-way review'",
      "modes": "",
      "disabled": false,
      "refs": [],
      "scripts": [],
    ...
    },
    {
      ...
      "art": "",
      "artPng": false,
      "blurb": "Teaches the AI to design like a high-end agency…",
      "level": "Advanced",
      "ramp": "teal",
      "tabler": "ti-puzzle",
      "src": "own",
    ...
    },
    {
      ...
      "art": "",
      "artPng": false,
      "blurb": "Raw mechanical interfaces fusing Swiss typographic print with military terminal aesthetics…",
      "level": "Advanced",
      "ramp": "teal",
      "tabler": "ti-puzzle",
      "src": "own",
    ...
    },
    {
      ...
      "art": "",
      "artPng": false,
      "blurb": "Clean editorial-style interfaces…",
      "level": "Advanced",
      "ramp": "teal",
      "tabler": "ti-puzzle",
      "src": "own",
    ...
    },
    {
      ...
      "art": "",
      "artPng": false,
      "blurb": "Semantic Design System Skill for Google Stitch…",
      "level": "Advanced",
      "ramp": "teal",
      "tabler": "ti-puzzle",
      "src": "own",
